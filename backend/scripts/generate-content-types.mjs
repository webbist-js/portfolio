...
const apis = {
  ...
  global: {
    ...
    attributes: {
      ...
      availabilityNote: { type: 'string', description: 'e.g. "booking from Q3 2026"' },
      capacityLabel: { type: 'string', description: 'e.g. "Q3 2026 capacity"' },
      capacityOpenPercent: { type: 'integer', min: 0, max: 100 },
