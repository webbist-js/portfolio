...
const apis = {
  project: {
    ...
    attributes: {
      ...
      kind: {
        type: 'enumeration',
        enum: ['employed', 'independent'],
        default: 'employed',
        description: 'Employer-led work is labelled as such so it is never mistaken for a commissioned engagement',
      },
      challenge: { type: 'text' },
      responsibility: { type: 'text', description: '"My responsibility": what I owned versus what the wider team did' },
      approach: { type: 'text' },
      outcome: { type: 'text' },
      learned: { type: 'text', description: '"What I learned": a trade-off, a decision that mattered, or what I would do differently' },
  ...
  article: {
    ...
    attributes: {
      ...
      updated: { type: 'date', description: 'Set by hand when the piece is substantively revised; shown next to the date' },
  ...
  service: {
    ...
    attributes: {
      ...
      deliverables: { type: 'text', description: '"What you receive": the artefacts at the end of the engagement' },
      nextSteps: { type: 'text', description: '"What happens next": the boundary of the engagement and what can follow' },
      sectors: { type: 'string', description: 'Where this offer has been delivered, e.g. "Public sector · GLAM · Retail"' },
      testimonial: {
        type: 'relation',
        relation: 'oneToOne',
        target: 'api::testimonial.testimonial',
        description: 'Quote shown on the service card; pick one that speaks to this capability',
      },
      order: { type: 'integer', default: 0 },
    },
  },
